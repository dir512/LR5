...
import java.io.File;
    ...
    public class Main {
        ...
        public static void main( String[] args )throws IOException {
            ...
            String[] razbiv_name_type = name_type_file.split("\\.");//массив из 2 элементов: название и тип файла

            String name_file = razbiv_name_type[0];//название
            String type_file = razbiv_name_type[1];//тип
